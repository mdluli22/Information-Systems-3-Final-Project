...
<body>
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <!-- search bar -->
            <form action="ticketCreation_all_tickets.php" class="search">
            ...
            <nav>
                <ul>
                    ...
                    <li id="allTickets"><a class="sidebar-links active" href="ticketCreation_all_tickets.php"><img src="pictures/receipt-icon.png" alt="receipt-icon">All Tickets</a></li>
