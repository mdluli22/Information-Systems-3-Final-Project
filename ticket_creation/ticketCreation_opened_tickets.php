...
<body>
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <!-- search bar -->
            <form action="ticketCreation_opened_tickets.php" class="search">
            ...
            <nav>
                <ul>
                    ...
                    <li id="openTickets"><a class="sidebar-links active" href="ticketCreation_opened_tickets.php"><img src="pictures/layer.png" alt="layer">Opened Tickets</a></li>
