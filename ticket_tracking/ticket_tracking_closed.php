    ...
    <div class="container">
            ...
            <header>
                <div>
                    ...
                    <?php //unseen tickets Notification
                        $sql_unseen = "SELECT COUNT(*) AS unseen_count FROM systemsurgeons.ticket WHERE userName = '$userID' AND s_seen = 0 AND ((ticket_status = 'Closed') or (ticket_status = 'Rejected'))";
                        ...
                        if ( $unseen_count > 0) {
                            echo "<p class='fade-out'>View and make comments on closed and rejected tickets. <span style='color: #ef3e3e;'> You have $unseen_count new tickets</span></p>";
                        } else {
                            echo "<p class='fade-out'>View and make comments closed and rejected tickets.</p>";
                        }
                    ?>
                </div>
                <!-- Fix the logo size -->
            ...
            <div class="content-wrapper">
                ...
                <section class="ticket-list">
                    ...
                    <?php
                        ...
                        $sql = "SELECT ticketID, resName, ticket_status, s_seen FROM systemsurgeons.ticket where userName = '$userID' and ( (ticket_status = 'Closed') or (ticket_status = 'Rejected'))";
                        $result = $connection -> query($sql); //execute query
                        ...
                        if ($result -> num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                if ($row['s_seen'] == 0) {
                                    echo "<td><a href='ticket_tracking_closed.php?ticketID={$row['ticketID']}&mark_seen=1' class='details-button-unseen'>View Details</a></td>"; // If ticket is unseen
                                } else {
                                    echo "<td><a href='ticket_tracking_closed.php?ticketID={$row['ticketID']}&mark_seen=1' class='details-button'>View Details</a></td>"; // If the ticket has been seen
                                }
                    ...
                    echo "<section class='scrollbar'>";
                        if ($result -> num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                $statusClass = "status " . strtolower($row['ticket_status']);
                                echo "<td><span class='{$statusClass}'><span class='circle'></span>&nbsp;&nbsp;{$row['ticket_status']}</span></td>";
                                echo "<td><a href='ticket_tracking_closed.php?ticketID={$row['ticketID']}&mark_seen=1' class='details-button'>View Details</a></td>";
                                echo "</tr>";
                            } //end table
                            echo "</table>";
                        }
                            ...
                            if (isset($_GET['ticketID'])) {
                                ...
                                if ($photos_result->num_rows > 0) {
                                    ...
                                    while ($photo = $photos_result->fetch_assoc()) {
                                        ...
                                        if ($ticketowner == $userID) {
                                            ...
                                            echo "<input type='hidden' name='page' value='closed'>";
                                ...
                                if (!empty($ticketowner)) { //display ticket details if the ticket details exists
                                    ...
                                    echo "<table class='info-table'>";
                                        ...
                                        echo "</td>";
                                        echo "<tr>";
                                            echo "<td class='info-cell' colspan='2'>";
        ...
        <script> 
            document.addEventListener('DOMContentLoaded', function() {
                const unseenCount = <?php echo $unseen_count_closed; ?>;
