            ...
            <div class="content-wrapper">
                ...
                <section class="ticket-list">
                    ...
                    <?php
                        ...
                        $sql = "SELECT ticketID, resName, ticket_status FROM systemsurgeons.ticket where userName = '$userID' and ( (ticket_status = 'Opened') or (ticket_status ='Processing'))";
                        $result = $connection -> query($sql); //execute query
                    ...
                    echo "<p class='info-label'>No open tickets were found for you.</p>";
                }
                echo "</section";
                ?>
                <br>
                    ...
                    if ($result -> num_rows > 0) {
                        ...
                        echo "<p class='info-label'>No open tickets were found for your residence.</p>";
                    }
                    echo "</section";
                    ?>
                </section>
                ...
                <section class="ticket-detail">
                    <article class="ticket-info">
                        ...
                        <?php
                            ...
                            //query instructions for the student's tickets
                            $sql = "SELECT ticketID, userName, resName, ticket_status, ticketDate, ticket_description, category, priority  FROM systemsurgeons.ticket where ticketID = '$ticketID' and (( ticket_status = 'Pending') or (ticket_status ='Processing'))";
                            $result = $connection -> query($sql); //execute query
