            ...
            <header class="page-header">
                <div class="text-container">
                    ...
                    <?php //unseen tickets Notification
                        ...
                        $sql_unseen = "SELECT Count(*) as unseen_count  FROM ticket join residence on ticket.resName = residence.resName where w_seen = 0 and ticket.resName = '$thehouse' and ticket_status = 'Confirmed';";
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                {
                                    if ($row['ticket_status'] == "Confirmed") {
                                        ...
                                        // echo "<a href='house_warden_confirmed.php?ticket_ID={$row['ticketID']}'> Comment </a>";
                                        echo "<td><p><a href='house_warden_confirmed.php?ticket_ID={$row['ticketID']}&mark_seen=1' class='custom-button' id='viewButton'> View Details</a></p></td>";
                                        echo "<tr>";
