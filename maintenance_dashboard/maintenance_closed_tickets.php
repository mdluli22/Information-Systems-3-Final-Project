                ...
                <tbody>
                    ...
                    <?php
                        ...
                        while ($row = $result->fetch_assoc())
                        {
                            ...
                            echo "<td><p><a href='maintenance_closed_tickets.php?ticket_ID={$row['ticketID']}&house_name={$activeHouse}#{$row['ticketID']}' class='custom-button'' id='viewButton'> View Details</a></p></td></tr>";
                            //echo "<td><a href='updateStatus.php?ticket_ID={$row['ticketID']}&house_name={$activeHouse}' onclick= \"return confirm('Are you sure you want to update ticket status')\">Ticket Resolved</a></td>";
                            echo "<tr>";
