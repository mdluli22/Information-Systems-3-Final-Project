        ...
        <header class="page-header">
            <div class="text-container">
                ...
                <?php //unseen tickets Notification
                        ...
                        $sql_unseen = "SELECT Count(*) as unseen_count  FROM ticket join residence on ticket.resName = residence.resName where ticket_status = 'Closed' and h_seen = 0 and hall_name = '$hallname';";
                        ...
                        <?php
                            ...
                            if ($ticket_result->num_rows > 0) {
                                while ($row = $ticket_result->fetch_assoc())
                                {
                                    ...
                                    // echo "<td><a href='hall_secretary_closed_tickets.php?ticket_ID={$row['ticketID']}&house_name={$activeHouse}'> Comment </a>";
                                    echo "<td><p><a href='hall_secretary_closed_tickets.php?ticket_ID={$row['ticketID']}&house_name={$activeHouse}&mark_seen=1' class='custom-button' id='viewButton'> View Details</a></p></td>";
                                    echo "<tr>";
