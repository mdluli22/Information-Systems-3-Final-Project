        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul id="sidebar-nav">
                    ...
                    <li id="open-tickets"><a class="sidebar-links active" href="<?php echo "house_warden_open_tickets.php?warden_userName=$warden_userName&hall_name=$resName"; ?>"><img src="pictures/layer.png" alt="layer">Opened Tickets</a></li>
