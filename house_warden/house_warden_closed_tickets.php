...
<body>  
    ...
    <?php
        ...
        $sql = "SELECT * FROM ticket WHERE resName = '$resname' AND ticket_status = 'Rejected' ORDER BY ticketID DESC;";
            ...
            <div class="text-container">
                ...
                <p>Access & Manage maintenance requisitions efficiently.</p>
                    <?php //unseen tickets Notification
                        ...
                        $sql_unseen = "SELECT Count(*) as unseen_count  FROM ticket join residence on ticket.resName = residence.resName where w_seen = 0 and ticket.resName = '$thehouse' and ticket_status = 'Closed';";
                    ...
                    <tbody>
                        ...
                        <?php
                            if($result -> num_rows > 0){
                                ...
                                {
                                    if ($row['ticket_status'] == "Closed" || $row['ticket_status'] == "Rejected") {
                                        ...
                                        // echo "<td><a href='house_warden_closed_tickets.php?ticket_ID={$row['ticketID']}'> Comment </a>";
                                        echo "<td><p><a href='house_warden_closed_tickets.php?ticket_ID={$row['ticketID']}&mark_seen=1' class='custom-button' id='viewButton'> View Details</a></p></td>";
                                        echo "<tr>";
