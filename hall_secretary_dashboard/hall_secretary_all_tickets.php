        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul id="sidebar-nav">
                    ...
                    <li id="statistics"><a class="sidebar-links" href="<?php echo "../Statistics/index.php?hall_sec_userName=$hall_sec_userName&hall_name=$hall_name"?>"><img src="pictures/bar-chart-icon.png" alt="bar chart icon">Statistics</a></li>
                </ul>
            </nav>
