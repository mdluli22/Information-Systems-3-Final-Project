            ...
            <div class="text-container">
                ...
                <p>Access & Manage maintenance requisitions efficiently.</p>
                    <?php //unseen tickets Notification
                        ...
                        $sql_unseen = "SELECT Count(*) as unseen_count  FROM ticket join residence on ticket.resName = residence.resName where w_seen = 0 and ticket.resName = '$thehouse';";
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc())
                                {
                                    if ($row['ticket_status'] != "Pending") {
                                        ...
                                        // echo "<td><a href='house_warden_all_tickets.php?ticket_ID={$row['ticketID']}'> Comment </a>";
                                        echo "<td><p><a href='house_warden_all_tickets.php?ticket_ID={$row['ticketID']}&mark_seen=1'class='custom-button' id='viewButton'> View Details</a></p></td></tr>";
                                        echo "<tr>";
